                  ...
                  <div class="col-xl-3 col-lg-4">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="border p-3 rounded mt-4">
                          <h5 class="font-size-16 mb-0 custom-accordion">
                            <a
                      ...
                      <div class="col-xl-4 col-sm-6">
                        <div class="card">
                          <div class="card-body">
                            <div class="product-img">
                              <img
                                src="assets/BackOffice/images/product/img-10.png"
                                alt=""
                                class="img-fluid mx-auto d-block"
                              />
                            </div>
                      ...
                      <div class="col-xl-4 col-sm-6">
                        <div class="card">
                          <div class="card-body">
                            <div class="product-img">
                              <img
                                src="assets/BackOffice/images/product/img-12.png"
                                alt=""
                                class="img-fluid mx-auto d-block"
                              />
                            </div>
                      ...
                      <div class="col-xl-4 col-sm-6">
                        <div class="card">
                          <div class="card-body">
                            <div class="product-img">
                              <img
                                src="assets/BackOffice/images/product/img-14.png"
                                alt=""
                                class="img-fluid mx-auto d-block"
                              />
                            </div>
                      ...
                      <div class="col-xl-4 col-sm-6">
                        <div class="card">
                          <div class="card-body">
                            <div class="product-img">
                              <img
                                src="assets/BackOffice/images/product/img-13.png"
                                alt=""
                                class="img-fluid mx-auto d-block"
                              />
                            </div>
                        ...
                        <div class="card">
                          <div class="card-body">
                            <div class="product-img">
                              ...
                              <img
                                src="assets/BackOffice/images/product/img-6.png"
                                alt=""
                                class="img-fluid mx-auto d-block"
                              />
                            </div>
                              ...
                              <div class="col-sm-6">
                                <div>
                                  <p class="mb-sm-0 mt-2">
                                    Page <span class="font-weight-bold">2</span>{" "}
                                    Of <span class="font-weight-bold">113</span>
                                  </p>
                                </div>
                              </div>
                              <div class="col-sm-6">
